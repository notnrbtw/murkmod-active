...
install_plugin_legacy() {
  local raw_url="https://raw.githubusercontent.com/notnrbtw/murkmod-active/main/plugins"

  echo "Find a plugin you want to install here: "
  echo "  https://github.com/notnrbtw/murkmod-active/tree/main/plugins"
  ...
  if [[ $plugin_info == *"Not Found"* ]]; then
    ...
    echo "Installing..."
    doas "pushd /mnt/stateful_partition/murkmod/plugins && curl https://raw.githubusercontent.com/notnrbtw/murkmod-active/main/plugins/$plugin_name -O && popd" > /dev/null
...
do_dev_updates() {
    ...
    doas "MURKMOD_BRANCH=$branch bash <(curl -SLk https://raw.githubusercontent.com/notnrbtw/murkmod-active/main/murkmod.sh)"
    exit
}
...
do_updates() {
    doas "bash <(curl -SLk https://raw.githubusercontent.com/notnrbtw/murkmod-active/main/murkmod.sh)"
    exit
}
...
install_plugins() {
    ...
    json=$(curl -s "https://api.github.com/repos/notnrbtw/murkmod-active/contents/plugins")
    file_contents=()
    download_urls=()    
